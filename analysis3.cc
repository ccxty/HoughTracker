...
void analysis3() {
    ...
    //         string total_file = "./total_" + particle_str[i_particle] +
    //         ".txt"; ifstream in_total(total_file); double total = 0; int
    //         i_total = 0; while (!in_total.eof()) {
    //             in_total >> total;
    //             if (i_total == 2) {
    //                 break;
    //             } else {
    ...
    //                                 static_cast<double>(n_all);
    //         }
    //         auto g_eff = new TGraphErrors(10, noise_double.data(),
    //         eff.data(),
    //                                       0, eff_err.data());
